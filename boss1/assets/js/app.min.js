...
function(e) {
    ...
    t.prototype._resetSidebarScroll = function() {
        ...
        e(".button-menu-mobile").on("click", function(t) {
            ...
            this.href == t && (e(this).addClass(""), e(this).parent().addClass(""), e(this).parent().parent().addClass("in"), e(this).parent().parent().prev().addClass("active"), e(this).parent().parent().parent().addClass("active"), e(this).parent().parent().parent().parent().addClass("in"), e(this).parent().parent().parent().parent().parent().addClass("active"))
