...
while($row = mysqli_fetch_array($result))
{
 ...
 $chart_data .= "{ Name:'".$row["Name"]."', Project:".$row["Project"]."}, ";
...
<!-- Mirrored from coderthemes.com/adminto/layouts/light/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 08:37:10 GMT -->
<head>
        <meta charset="utf-8" />
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card-box">
                                    ...
                                    <div class="widget-chart text-center">
                                        <div id="donutAbc" dir="ltr" style="height: 245px;" class="morris-chart"></div>
                                    </div>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-xl-4">
                                <div class="card-box">
                                    ...
                                    <div id="bar-example" dir="ltr" style="height: 280px;" class="morris-chart"></div>
                                </div>
                            </div><!-- end col -->
...
<!-- Mirrored from coderthemes.com/adminto/layouts/light/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 08:37:35 GMT -->
</html>